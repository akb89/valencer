...
JsonpMainTemplatePlugin.prototype.apply = function (mainTemplate) {
	...
	mainTemplate.plugin("hot-bootstrap", function (source, chunk, hash) {
		...
		return source + "\n" + "var parentHotUpdateCallback = this[" + JSON.stringify(hotUpdateFunction) + "];\n" + "this[" + JSON.stringify(hotUpdateFunction) + "] = " + Template.getFunctionContent(require("./JsonpMainTemplate.runtime.js")).replace(/\$require\$/g, this.requireFn).replace(/\$hotMainFilename\$/g, currentHotUpdateMainFilename).replace(/\$hotChunkFilename\$/g, currentHotUpdateChunkFilename).replace(/\$hash\$/g, JSON.stringify(hash));
	});
...
//# sourceMappingURL=JsonpMainTemplatePlugin-compiled.js.map