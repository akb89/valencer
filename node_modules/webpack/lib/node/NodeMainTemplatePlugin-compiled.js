...
NodeMainTemplatePlugin.prototype.apply = function (mainTemplate) {
	...
	mainTemplate.plugin("hot-bootstrap", function (source, chunk, hash) {
		...
		return Template.getFunctionContent(self.asyncChunkLoading ? require("./NodeMainTemplateAsync.runtime.js") : require("./NodeMainTemplate.runtime.js")).replace(/\$require\$/g, this.requireFn).replace(/\$hotMainFilename\$/g, currentHotUpdateMainFilename).replace(/\$hotChunkFilename\$/g, currentHotUpdateChunkFilename);
	});
...
//# sourceMappingURL=NodeMainTemplatePlugin-compiled.js.map