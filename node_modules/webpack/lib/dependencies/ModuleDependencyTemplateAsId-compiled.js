...
ModuleDependencyTemplateAsId.prototype.apply = function (dep, source, outputOptions, requestShortener) {
	...
	if (dep.module) var content = comment + JSON.stringify(dep.module.id);else var content = require("./WebpackMissingModule").module(dep.request);
...
//# sourceMappingURL=ModuleDependencyTemplateAsId-compiled.js.map