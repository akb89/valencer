...
ModuleDependencyTemplateAsRequireId.prototype.apply = function (dep, source, outputOptions, requestShortener) {
	...
	if (dep.module) var content = "__webpack_require__(" + comment + JSON.stringify(dep.module.id) + ")";else var content = require("./WebpackMissingModule").module(dep.request);
...
//# sourceMappingURL=ModuleDependencyTemplateAsRequireId-compiled.js.map