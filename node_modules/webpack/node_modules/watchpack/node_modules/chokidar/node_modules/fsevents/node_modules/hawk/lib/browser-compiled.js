...
var CryptoJS = CryptoJS || function (h, r) {
    var k = {},
        ...
        }, _minBufferSize: 0 });l.Hasher = q.extend({ cfg: f.extend(), init: function (a) {
...
(function () {
    var k = CryptoJS,
        ...
        l = b.Hasher,
        d = [],
        b = k.algo.SHA1 = l.extend({ _doReset: function () {
...
(function (k) {
    for (var g = CryptoJS, h = g.lib, v = h.WordArray, j = h.Hasher, h = g.algo, s = [], t = [], u = function (q) {
        ...
        h = h.SHA256 = j.extend({ _doReset: function () {
...
(function () {
    var c = CryptoJS,
        k = c.enc.Utf8;c.algo.HMAC = c.lib.Base.extend({ init: function (a, b) {
