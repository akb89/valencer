...
startWatcher("sub+files", [path.join(folder, "a.txt"), path.join(folder, "b.txt"), path.join(folder, "c.txt"), path.join(folder, "d.txt")], [path.join(folder, "subfolder")]);

//# sourceMappingURL=watch-folder-compiled.js.map