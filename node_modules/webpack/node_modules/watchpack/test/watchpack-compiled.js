...
describe("Watchpack", function () {
	...
	it("should watch multiple files", function (done) {
		...
		w.on("aggregated", function (changes) {
			...
			Object.keys(w.getTimes()).sort().should.be.eql([path.join(fixtures, "a"), path.join(fixtures, "b")]);
			w.close();
			done();
		});
	...
	it("should watch file in a sub sub directory", function (done) {
		...
		w.on("aggregated", function (changes) {
			...
			Object.keys(w.getTimes()).sort().should.be.eql([path.join(fixtures, "dir"), path.join(fixtures, "dir", "sub"), path.join(fixtures, "dir", "sub", "sub"), path.join(fixtures, "dir", "sub", "sub", "a")]);
			w.close();
			done();
		});
		testHelper.dir("dir");
...
//# sourceMappingURL=watchpack-compiled.js.map