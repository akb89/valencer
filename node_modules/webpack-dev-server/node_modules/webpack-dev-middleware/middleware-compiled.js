...
module.exports = function (compiler, options) {
	...
	function ready(fn, req) {
		if (state) return fn();
		if (!options.noInfo && !options.quiet) console.log("webpack: wait until bundle finished: " + (req.url || fn.name));
		callbacks.push(fn);
	}
	...
	webpackDevMiddleware.waitUntilValid = function (callback) {
		...
		if (!watching || !watching.running) callback();else ready(callback, {});
	};
