...
function processText(text, configHelper, filename, fix, allowInlineConfig) {
    ...
    var filePath, config, messages, stats, fileExtension, processor, loadedPlugins, fixedResult;
...
CLIEngine.prototype = {
     ...
     */
    executeOnText: function executeOnText(text, filename) {
...
//# sourceMappingURL=cli-engine-compiled.js.map