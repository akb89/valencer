...
module.exports = {
    ...
    create: function (context) {
        ...
        function checkImport(node) {
            ...
            if (node.imported.name === node.local.name && node.imported !== node.local) {
        ...
        function checkExport(node) {
            ...
            if (node.local.name === node.exported.name && node.local !== node.exported) {
...
//# sourceMappingURL=no-useless-rename-compiled.js.map